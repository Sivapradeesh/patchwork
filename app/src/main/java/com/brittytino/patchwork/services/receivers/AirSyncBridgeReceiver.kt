            ...
            if (isEnabled) {
                ...
                kotlinx.coroutines.CoroutineScope(kotlinx.coroutines.Dispatchers.IO).launch {
                    try {
                        ...
                        val glanceIds =
                            glanceAppWidgetManager.getGlanceIds(com.brittytino.patchwork.services.widgets.BatteriesWidget::class.java)
                        ...
                        glanceIds.forEach { glanceId ->
                            ...
                            com.brittytino.patchwork.services.widgets.BatteriesWidget()
