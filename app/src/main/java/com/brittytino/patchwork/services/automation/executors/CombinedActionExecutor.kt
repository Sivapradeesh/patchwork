                        ...
                        try {
                            if (action.enabled) {
                                ...
                                val componentName = android.content.ComponentName(
                                    context,
                                    com.brittytino.patchwork.services.EssentialsConditionProvider::class.java
                                )
                                val conditionUri =
                                    com.brittytino.patchwork.services.EssentialsConditionProvider.CONDITION_URI
                                ...
                                val ruleBuilder = android.app.AutomaticZenRule.Builder(
                                    ...
                                    .setConfigurationActivity(
                                        android.content.ComponentName(
                                            context,
                                            com.brittytino.patchwork.MainActivity::class.java
                                        )
                                    )
                                ...
                                com.brittytino.patchwork.services.EssentialsConditionProvider.setConditionState(
                                    context,
                                    true
                                )
