                    ...
                    if (event is VolumePressEvent.LongPress) {
                        ...
                        if (isTorchOn) {
                            ...
                            if (isAdjustEnabled || isGlobalEnabled) {
                                val action =
                                    if (event.direction == com.brittytino.patchwork.input.VolumeDirection.UP)
                                ...
                                val key =
                                    if (event.direction == com.brittytino.patchwork.input.VolumeDirection.UP) "button_remap_vol_up_action$suffix" else "button_remap_vol_down_action$suffix"
