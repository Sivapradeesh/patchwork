    ...
    Column(
        ...
        RoundedCardContainer {
            ...
            val isAirSyncInstalled = try {
                context.packageManager.getPackageInfo("com.brittytino.airsync", 0)
                true
                        ...
                        androidx.compose.material3.Button(
                            onClick = {
                                val intent = android.content.Intent(
                                    ...
                                    android.net.Uri.parse("https://play.google.com/store/apps/details?id=com.brittytino.airsync")
                                )
