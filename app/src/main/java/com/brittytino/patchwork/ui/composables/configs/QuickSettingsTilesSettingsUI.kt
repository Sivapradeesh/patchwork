...
import com.brittytino.patchwork.services.tiles.BatteryNotificationTileService
...
import com.brittytino.patchwork.services.tiles.ChargeQuickTileService
import com.brittytino.patchwork.services.tiles.DeveloperOptionsTileService
...
import com.brittytino.patchwork.utils.PermissionUIHelper
...
fun QuickSettingsTilesSettingsUI(
    ...
    val tiles = listOf(
        ...
        QSTileInfo(
            ...
            com.brittytino.patchwork.services.tiles.ColorPickerTileService::class.java,
            emptyList(),
    ...
    if (showHelpSheet && selectedHelpTile != null) {
        ...
        val tempFeature = object : com.brittytino.patchwork.domain.model.Feature(
            id = tileId,
