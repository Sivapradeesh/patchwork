        ...
        RoundedCardContainer {
            ...
            IconToggleItem(
                ...
                onCheckedChange = { checked ->
                    ...
                    val currentlyEnabled = com.brittytino.patchwork.utils.PermissionUtils.isAccessibilityServiceEnabled(context)
                    if (checked && !currentlyEnabled) {
                        com.brittytino.patchwork.utils.PermissionUtils.openAccessibilitySettings(context)
                    } else {
