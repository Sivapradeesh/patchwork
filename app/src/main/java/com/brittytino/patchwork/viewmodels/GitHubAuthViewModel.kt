...
import com.brittytino.patchwork.data.repository.GitHubAuthRepository
...
class GitHubAuthViewModel : ViewModel() {
    ...
    private val gitHubRepository = com.brittytino.patchwork.data.repository.GitHubRepository()

    private val _authState = mutableStateOf<AuthState>(AuthState.Idle)
    val authState: State<AuthState> = _authState

    private val _currentUser =
        mutableStateOf<com.brittytino.patchwork.domain.model.github.GitHubUser?>(null)
    val currentUser: State<com.brittytino.patchwork.domain.model.github.GitHubUser?> = _currentUser
