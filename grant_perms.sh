...
# Configuration
RELEASE_PKG="com.brittytino.patchwork"
DEBUG_PKG="com.brittytino.patchwork.debug"
...
grant_permissions() {
    ...
    LISTENER="$PKG/com.brittytino.patchwork.services.NotificationListener"
    adb shell settings put secure enabled_notification_listeners $LISTENER

    # Accessibility Service
    ACCESSIBILITY="$PKG/com.brittytino.patchwork.services.tiles.ScreenOffAccessibilityService"
